...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "research",
          description: "articles, preprints, and R packages.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/tijn-jacobs", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/tijn-jacobs-869554165", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0003-6188-9296", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=3o80X54AAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
